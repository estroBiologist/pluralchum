...
function headsUp(onConfirm, onCancel) {
  BdApi.UI.showConfirmationModal(
    ...
    <div align="center" style={{ color: "#eeeeee" }}>
      ...
      between sessions. None of this data is ever shared, collected or uploaded,
      but you still ought to know.
      <br />
      <br />
      <b>You can clear this cache at any time in the plugin settings</b>, and
      unused cache data is automatically deleted after 30 days.
    </div>,
    {
      confirmText: "Gotcha",
...
module.exports = { initializeSettings, requireEula };
